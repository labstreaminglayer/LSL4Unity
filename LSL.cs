...
namespace LSL4Unity
{
    public class liblsl
    {
        ...
        */
        ...
        {
            post_none =
                0, // No automatic post-processing; return the ground-truth time stamps for manual post-processing

            // (this is the default behavior of the inlet).
            post_clocksync =
                1, // Perform automatic clock synchronization; equivalent to manually adding the time_correction() value

            // to the received time stamps.
            post_dejitter =
                2, // Remove jitter from time stamps. This will apply a smoothing algorithm to the received time stamps;
            ...
            post_monotonize =
                4, // Force the time-stamps to be monotonically ascending (only makes sense if timestamps are dejittered).

            post_threadsafe =
                8, // Post-processing is thread-safe (same inlet can be read from by multiple threads); uses somewhat more CPU.
        ...
        */
        public class StreamInfo
        {
            ...
            */
            ...
            {
                obj = dll.lsl_create_streaminfo(name, type, 1, IRREGULAR_RATE, channel_format_t.cf_float32, "");
            }
        ...
        */
        public class StreamOutlet
        {
            ...
            */
            ...
            {
                dll.lsl_push_sample_ftp(obj, data, 0.0, 1);
            }

            public void push_sample(float[] data, double timestamp)
            {
                dll.lsl_push_sample_ftp(obj, data, timestamp, 1);
            }

            public void push_sample(float[] data, double timestamp, bool pushthrough)
            {
            ...
            {
                dll.lsl_push_sample_dtp(obj, data, 0.0, 1);
            }

            public void push_sample(double[] data, double timestamp)
            {
                dll.lsl_push_sample_dtp(obj, data, timestamp, 1);
            }

            public void push_sample(double[] data, double timestamp, bool pushthrough)
            {
            ...
            {
                dll.lsl_push_sample_itp(obj, data, 0.0, 1);
            }

            public void push_sample(int[] data, double timestamp)
            {
                dll.lsl_push_sample_itp(obj, data, timestamp, 1);
            }

            public void push_sample(int[] data, double timestamp, bool pushthrough)
            {
            ...
            {
                dll.lsl_push_sample_stp(obj, data, 0.0, 1);
            }

            public void push_sample(short[] data, double timestamp)
            {
                dll.lsl_push_sample_stp(obj, data, timestamp, 1);
            }

            public void push_sample(short[] data, double timestamp, bool pushthrough)
            {
                dll.lsl_push_sample_stp(obj, data, timestamp, pushthrough ? 1 : 0);
            }

            public void push_sample(char[] data)
            {
                dll.lsl_push_sample_ctp(obj, data, 0.0, 1);
            }

            public void push_sample(char[] data, double timestamp)
            {
                dll.lsl_push_sample_ctp(obj, data, timestamp, 1);
            }

            public void push_sample(char[] data, double timestamp, bool pushthrough)
            {
            ...
            {
                dll.lsl_push_sample_strtp(obj, data, 0.0, 1);
            }

            public void push_sample(string[] data, double timestamp)
            {
                dll.lsl_push_sample_strtp(obj, data, timestamp, 1);
            }
            ...
            */
            ...
            {
                dll.lsl_push_chunk_ftp(obj, data, (uint) data.Length, 0.0, 1);
            }

            public void push_chunk(float[,] data, double timestamp)
            {
                dll.lsl_push_chunk_ftp(obj, data, (uint) data.Length, timestamp, 1);
            }
            ...
            {
                dll.lsl_push_chunk_dtp(obj, data, (uint) data.Length, 0.0, 1);
            }

            public void push_chunk(double[,] data, double timestamp)
            {
                dll.lsl_push_chunk_dtp(obj, data, (uint) data.Length, timestamp, 1);
            }
            ...
            {
                dll.lsl_push_chunk_itp(obj, data, (uint) data.Length, 0.0, 1);
            }

            public void push_chunk(int[,] data, double timestamp)
            {
                dll.lsl_push_chunk_itp(obj, data, (uint) data.Length, timestamp, 1);
            }
            ...
            {
                dll.lsl_push_chunk_stp(obj, data, (uint) data.Length, 0.0, 1);
            }

            public void push_chunk(short[,] data, double timestamp)
            {
                dll.lsl_push_chunk_stp(obj, data, (uint) data.Length, timestamp, 1);
            }
            ...
            public void push_chunk(char[,] data)
            {
                dll.lsl_push_chunk_ctp(obj, data, (uint) data.Length, 0.0, 1);
            }

            public void push_chunk(char[,] data, double timestamp)
            {
                dll.lsl_push_chunk_ctp(obj, data, (uint) data.Length, timestamp, 1);
            }
            ...
            {
                dll.lsl_push_chunk_strtp(obj, data, (uint) data.Length, 0.0, 1);
            }

            public void push_chunk(string[,] data, double timestamp)
            {
                dll.lsl_push_chunk_strtp(obj, data, (uint) data.Length, timestamp, 1);
            }
            ...
            */
            ...
            {
                dll.lsl_push_chunk_ftnp(obj, data, (uint) data.Length, timestamps, 1);
            }
            ...
            {
                dll.lsl_push_chunk_dtnp(obj, data, (uint) data.Length, timestamps, 1);
            }
            ...
            {
                dll.lsl_push_chunk_itnp(obj, data, (uint) data.Length, timestamps, 1);
            }
            ...
            {
                dll.lsl_push_chunk_stnp(obj, data, (uint) data.Length, timestamps, 1);
            }
            ...
            public void push_chunk(char[,] data, double[] timestamps)
            {
                dll.lsl_push_chunk_ctnp(obj, data, (uint) data.Length, timestamps, 1);
            }
            ...
            {
                dll.lsl_push_chunk_strtnp(obj, data, (uint) data.Length, timestamps, 1);
            }
            ...
            */
            public bool wait_for_consumers(double timeout)
            {
        ...
        */
        public class StreamInlet
        {
            ...
            */
            ...
            {
                obj = dll.lsl_create_inlet(info.handle(), max_buflen, 0, 1);
            }
            ...
            */
            ...
            {
                set_postprocessing(processing_options_t.post_ALL);
            }

            public void set_postprocessing(processing_options_t post_flags)
            {
                dll.lsl_set_postprocessing(obj, post_flags);
            }
            ...
            */
            public double pull_sample(float[] sample)
            {
            ...
            public double pull_sample(double[] sample)
            {
                return pull_sample(sample, FOREVER);
            }
            ...
            public double pull_sample(int[] sample)
            {
                return pull_sample(sample, FOREVER);
            }
            ...
            public double pull_sample(short[] sample)
            {
                return pull_sample(sample, FOREVER);
            }
            ...
            public double pull_sample(char[] sample)
            {
                return pull_sample(sample, FOREVER);
            }
            ...
            public double pull_sample(string[] sample)
            {
                return pull_sample(sample, FOREVER);
            }
            ...
            * @throws LostException (if the stream source has been lost).
            */
            public int pull_chunk(float[,] data_buffer, double[] timestamp_buffer)
            {
            ...
            public int pull_chunk(double[,] data_buffer, double[] timestamp_buffer)
            {
                return pull_chunk(data_buffer, timestamp_buffer, 0.0);
            }
            ...
            public int pull_chunk(int[,] data_buffer, double[] timestamp_buffer)
            {
                return pull_chunk(data_buffer, timestamp_buffer, 0.0);
            }
            ...
            public int pull_chunk(short[,] data_buffer, double[] timestamp_buffer)
            {
                return pull_chunk(data_buffer, timestamp_buffer, 0.0);
            }
            ...
            public int pull_chunk(char[,] data_buffer, double[] timestamp_buffer)
            {
                return pull_chunk(data_buffer, timestamp_buffer, 0.0);
            }
            ...
            public int pull_chunk(string[,] data_buffer, double[] timestamp_buffer)
            {
                return pull_chunk(data_buffer, timestamp_buffer, 0.0);
            }
