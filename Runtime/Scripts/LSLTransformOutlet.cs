...
using LSL4Unity.Scripts.Common;
...
namespace LSL4Unity.Scripts
{
    ...
    public class LSLTransformOutlet : MonoBehaviour
    {
        ...
        /// </summary>
        private const double dataRate = LSL.LSL.IRREGULAR_RATE;
        ...
        void Start()
        {
            ...
            streamInfo = new StreamInfo(StreamName, StreamType, channelCount, dataRate, channel_format_t.cf_float32, unique_source_id);
        ...
        private void sample()
        {
            ...
            outlet.push_sample(currentSample, LSL.LSL.local_clock());
        }
